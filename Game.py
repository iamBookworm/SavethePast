...
def ButtonSelection():
    ...
    if keys [pygame.K_v]:
        ...
        pygame.time.wait(10)
        pygame.display.flip()
        image = pygame.image.load('PrebathVanessa.png').convert()
        world.blit(image, [0,0])
        pygame.display.flip()
        v = pygame.sprite.Sprite()
        v.image = pygame.image.load("vanessathechar.png").convert_alpha()
    ...
    if keys [pygame.K_d]:
        ...
        pygame.time.wait(10)
        pygame.display.flip()
        image = pygame.image.load('PrebathDave.png').convert()
        world.blit(image, [0,0])
        pygame.display.flip()
        d = pygame.sprite.Sprite() # create sprite
        d.image = pygame.image.load("300dave.png").convert_alpha() # load ball image
...
def Water():
    ...
    if keys [pygame.K_w]:
        ...
        pygame.time.wait(10)
        pygame.display.flip()
        image = pygame.image.load('PostbathVanessa.png').convert()
        world.blit(image, [0,0])
        pygame.display.flip()
        v = pygame.sprite.Sprite()
        v.image = pygame.image.load("vanessathechar.png").convert_alpha()
    ...
    if keys [pygame.K_r]:
        ...
        pygame.time.wait(10)
        pygame.display.flip()
        image = pygame.image.load('PostbathDave.png').convert()
        world.blit(image, [0,0])
        pygame.display.flip()
...
def Outside():
    ...
    if keys [pygame.K_b]:
        ...
        d.image = pygame.image.load("300dave.png").convert_alpha() # load ball image
        d.rect = d.image.get_rect() # use image extent values
        d.rect.topleft = [300, 275] # put the ball in the top left corner
        world.blit(d.image, d.rect)
        pygame.display.flip()
        print("Americans now use 127 percent more water than we did in 1950.")
        print("About 95 percent of the water entering our homes goes down the drain.")
